...
class ObjectSpecificView(WMABaseView):
    ...
    def get_edit_url(self, obj=None):
        return self.url_helper.get_action_url('edit', quote(self.object_pk))

    def get_delete_url(self, obj=None):
        return self.url_helper.get_action_url('delete', quote(self.object_pk))
...
class EditView(ObjectSpecificView, CreateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if self.is_pagemodel:
            return redirect(
                self.button_helper.get_action_url('edit', self.object_pk))
        return super(CreateView, self).dispatch(request, *args, **kwargs)
...
class DeleteView(ObjectSpecificView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if self.is_pagemodel:
            return redirect(
                self.button_helper.get_action_url('delete', self.object_pk))
